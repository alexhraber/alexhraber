...
<pre>
  ...
  profile {
    name       │  Alex H. Raber
    role       │  Engineer · Founder · Systems Architect
    company    │  Decapod Labs
    location   │  Pacific Northwest
    languages  │  Rust, Go, Python, TypeScript, Nix
    domains    │  Agents · CI/CD · Cloud · Containers
               │  Distributed Systems · Governance
               │  Infrastructure · Kernel · Security · SRE
    current    │  Decapod — repo-native governance kernel
    principles │  Governed Automation · Proof-Backed Work
               │  Resilient Systems · Intent-Driven Delivery
  }
